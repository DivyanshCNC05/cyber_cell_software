...
<div class="row g-3">
  <div class="col-md-4"><a class="text-decoration-none" href="/dashboards/user1.php">
    <div class="card h-100"><div class="card-body"><h5 class="card-title">User1 Dashboard</h5></div></div>
  </a></div>

  <div class="col-md-4"><a class="text-decoration-none" href="/dashboards/user2.php">
    <div class="card h-100"><div class="card-body"><h5 class="card-title">User2 Dashboard</h5></div></div>
  </a></div>

  <div class="col-md-4"><a class="text-decoration-none" href="/dashboards/user3.php">
    <div class="card h-100"><div class="card-body"><h5 class="card-title">User3 Dashboard</h5></div></div>
  </a></div>

  <div class="col-md-4"><a class="text-decoration-none" href="/dashboards/ceir.php">
